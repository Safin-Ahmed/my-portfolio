                ...
                <div className="intro-left-wrapper">
                    ...
                    <div className="job-title">
                        <div className="job-title-wrapper">
                            ...
                            <div className="job-title-item">E-Commerce Expert</div>
                            <div className="job-title-item">Shopify Developer</div>
                            <div className="job-title-item">WordPress Expert</div>
                            <div className="job-title-item">Content Creator</div>
                        </div>
                    </div>
